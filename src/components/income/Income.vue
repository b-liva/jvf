  ...
  <div class="grid grid-cols-12 gap-6">
    <div class="col-span-2">
      <div class="col-span-2 m-3">
        <TimeLineList v-for="prop in props" v-bind="prop" page-name="income" class="my-2"/>
      </div>
    </div>
        ...
        <div class="col-span-8">
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mt-6">
            ...
            <tr v-for="(income, index) in incomes" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td class="text-sm text-center">{{income.proforma}}</td>
              ...
              <td class="text-sm text-center">
                <div class="relative bg-gray-200 rounded rounded-md">
                  <div class="bg-blue-800 text-white" :class="{'rounded-l-md': getPercentage(index) === 100}" :style="{width:`${getPercentage(index)}%`}">{{getPercentage(index)}}</div>
                </div>
              </td>
